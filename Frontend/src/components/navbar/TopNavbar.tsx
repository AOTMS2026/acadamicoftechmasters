            ...
            {!isLoggedIn ? (
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="flex items-center gap-1.5 hover:text-accent uppercase tracking-wider font-bold text-[9px] md:text-[10px] transition-colors"
                >
              ...
              <div className="flex items-center gap-3">
                <Link
                  to="/cart"
                  className="hidden md:flex items-center gap-1.5 hover:text-accent uppercase tracking-wider font-bold text-xs transition-colors"
                >
                  <FaBook className="w-3 h-3" />
                  <span>
                    <span className="lg:hidden">Enroll Cart</span>
                    <span className="hidden lg:inline">Enroll Cart</span> (
                    {cartItemCount})
                  </span>
                </Link>
